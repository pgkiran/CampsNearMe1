...
@implementation CampListViewController
...
- (void)objectsDidLoad:(NSError *)error {
 ...
 [query orderByDescending:@"createdAt"];
     ...
     //TODO
#warning to pass the camp type to this controller

     [query whereKey:@"CAMP_TYPE" equalTo:@"Sports"];
